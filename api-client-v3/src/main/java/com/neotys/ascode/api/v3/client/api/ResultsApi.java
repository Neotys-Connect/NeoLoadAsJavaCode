...
import com.neotys.ascode.api.v3.client.model.PatchCustomEventError400;
import com.neotys.ascode.api.v3.client.model.PatchCustomEventError404;
import com.neotys.ascode.api.v3.client.model.PatchCustomEventRequest;
import com.neotys.ascode.api.v3.client.model.PatchCustomEventResponse;
import com.neotys.ascode.api.v3.client.model.Percentiles;
import com.neotys.ascode.api.v3.client.model.Points;
import com.neotys.ascode.api.v3.client.model.PostCustomEventError;
import com.neotys.ascode.api.v3.client.model.PostCustomEventRequest;
import com.neotys.ascode.api.v3.client.model.PostCustomEventResponse;
...
public class ResultsApi {
     ...
     * Provides all the test result raw data, with a content as CSV or JSON file. &lt;br /&gt;&lt;br /&gt; &lt;b&gt;&lt;i&gt;This endpoint may produce large files depending on Test Results. For production purposes please prefer using an API client rather than the browser.&lt;/i&gt;&lt;/b&gt; 
     * @param workspaceId Unique identifier representing a Workspace. (required)
     * @param resultId Unique identifier representing a specific test result. (required)
     * @param format The format of the test result data. (required)
     * @return String
     ...
     * Provides the test result raw data for an element of category TRANSACTION, with a content as CSV or JSON file.
     * @param workspaceId Unique identifier representing a Workspace. (required)
     * @param resultId Unique identifier representing a specific test result. (required)
     * @param elementId Unique identifier representing a specific element. (required)
     * @param format The format of the test result data. (required)
     ...
     * Update a field of an existing custom event:   - endTimestamp   - description   - url  Custom events timestamps are in seconds.  Request to patch a custom event has some constraints, see &lt;a href&#x3D;\&quot;#model-PatchCustomEventRequest\&quot;&gt;PatchCustomEventRequest model&lt;/a&gt; to get more details. ____ 
     * @param body The patch of an existing custom event. (required)
     * @param workspaceId Unique identifier representing a Workspace. (required)
     * @param resultId Unique identifier representing a specific test result. (required)
     * @param eventId Unique identifier representing a specific test result event. (required)
