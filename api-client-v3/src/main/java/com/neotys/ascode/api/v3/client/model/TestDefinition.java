...
public class TestDefinition {
  ...
  **/
  ...
  public TestDefinition userModifierName(String userModifierName) {
  ...
  **/
  ...
  public TestDefinition creationDate(Long creationDate) {
  ...
  **/
  ...
  public TestDefinition lastUpdateDate(Long lastUpdateDate) {
  ...
  **/
  ...
  public TestDefinition scenarioName(String scenarioName) {
  ...
  **/
  ...
  public TestDefinition controllerZoneId(String controllerZoneId) {
  ...
  **/
  ...
  public TestDefinition projectId(String projectId) {
  ...
  **/
  ...
  public TestDefinition projectName(String projectName) {
   ...
   * @return projectName
  **/
  @Schema(example = "Sample Project", description = "Name of the project.")
  ...
  public TestDefinition lgZoneIds(Map<String, Integer> lgZoneIds) {
    this.lgZoneIds = lgZoneIds;
    return this;
  }

  public TestDefinition putLgZoneIdsItem(String key, Integer lgZoneIdsItem) {
  ...
  **/
  ...
  public TestDefinition lastRunDate(Long lastRunDate) {
    this.lastRunDate = lastRunDate;
    return this;
  }

   /**
   * Timestamp when the test was ran for the last time. Number of seconds since January 1, 1970.
   * @return lastRunDate
  **/
  @Schema(example = "1582550442", description = "Timestamp when the test was ran for the last time. Number of seconds since January 1, 1970.")
  ...
  public TestDefinition nextRunId(BigDecimal nextRunId) {
  ...
  **/
  ...
  public TestDefinition testResultNamingPattern(String testResultNamingPattern) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, testDefinition.id) &&
        ...
        Objects.equals(this.userModifierName, testDefinition.userModifierName) &&
        Objects.equals(this.creationDate, testDefinition.creationDate) &&
        Objects.equals(this.lastUpdateDate, testDefinition.lastUpdateDate) &&
        Objects.equals(this.scenarioName, testDefinition.scenarioName) &&
        Objects.equals(this.controllerZoneId, testDefinition.controllerZoneId) &&
        Objects.equals(this.projectId, testDefinition.projectId) &&
        Objects.equals(this.projectName, testDefinition.projectName) &&
        Objects.equals(this.lgZoneIds, testDefinition.lgZoneIds) &&
        Objects.equals(this.lastRunDate, testDefinition.lastRunDate) &&
        Objects.equals(this.nextRunId, testDefinition.nextRunId) &&
        Objects.equals(this.testResultNamingPattern, testDefinition.testResultNamingPattern);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, description, userModifierName, creationDate, lastUpdateDate, scenarioName, controllerZoneId, projectId, projectName, lgZoneIds, lastRunDate, nextRunId, testResultNamingPattern);
  }
