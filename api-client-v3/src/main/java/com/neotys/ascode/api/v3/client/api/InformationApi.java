...
public class InformationApi {
     ...
     * @return ArrayOfInformationDefinition
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ArrayOfInformationDefinition getInformation() throws ApiException {
        ApiResponse<ArrayOfInformationDefinition> resp = getInformationWithHttpInfo();
        return resp.getData();
    }
     ...
     * Lists information
     * Returns relevant information regarding Neoload Web resources and version.
     * @return ApiResponse&lt;ArrayOfInformationDefinition&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ArrayOfInformationDefinition> getInformationWithHttpInfo() throws ApiException {
        com.squareup.okhttp.Call call = getInformationValidateBeforeCall(null, null);
        Type localVarReturnType = new TypeToken<ArrayOfInformationDefinition>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Lists information (asynchronously)
     * Returns relevant information regarding Neoload Web resources and version.
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getInformationAsync(final ApiCallback<ArrayOfInformationDefinition> callback) throws ApiException {
